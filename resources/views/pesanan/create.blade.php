                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('pesanan.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="jumlah_tiket" class="block mt-1 w-full" type="number" name="jumlah_tiket" :value="old('jumlah_tiket')" min="1" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tanggal_naik" class="block mt-1 w-full" type="date" name="tanggal_naik" :value="old('tanggal_naik')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tanggal_turun" class="block mt-1 w-full" type="date" name="tanggal_turun" :value="old('tanggal_turun')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select name="metode_bayar" id="metode_bayar" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm @error('metode_bayar') border-red-500 @enderror" required>
                                ...
                                <option value="cash" {{ old('metode_bayar') == 'cash' ? 'selected' : '' }}>Tunai</option>
                            </select>
                            <x-input-error :messages="$errors->get('metode_bayar')" class="mt-2" />
                        </div>

                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('pesanan.index') }}" class="mr-4 text-gray-600 hover:text-gray-900">Batal</a>
                            <x-primary-button>
                                {{ __('Pesan Tiket') }}
                            </x-primary-button>
                        </div>
